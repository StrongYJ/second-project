...
public class MyTest {
    ...
    @Test
    void 확인용(){
        List<ImcomeSumDto> list = incomeRepo.sumByYearMonth(member, LocalDate.of(2023, 01, 01), LocalDate.of(2023, 01, 31));
        log.info(member.toString());
        // List<ImconeSumByYearMonthDto> list = iRepo.sumByYearMonth(member, YearMonth.of(2023, 1));
        System.out.println(list.size());
        for(ImcomeSumDto a : list){
            System.out.println(a.getYearMonth());

...
//    }
    ...
    public ResponseEntity<MessageExpenseDto> updateExpense(@Parameter(description = "지출 식별 번호", example = "1") @PathVariable("expense-id") Long expenseNo, @RequestBody ExpenseDetailDto data) {
    ...
    @PostMapping("/dummy")
    public ResponseEntity<MessageExpenseDto> putDummy(@RequestParam Long userNo, Integer size) {
    ...
    public ResponseEntity<List<ExpenseDetailDto>> getCategory(@Parameter(description = "회원 식별 번호", example = "1") @PathVariable("member-id") Long memberId, @Parameter(description = "조회연월", example = "2302") @RequestParam Integer date, @Parameter(description = "카테고리", example = "아메리카노") String keyword) {
